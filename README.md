...
### About the app- Angular Movie Explorer – Powered by NgRx

A real-world Angular movie application showcasing NgRx for scalable state management.

✔️ Feature Store Architecture
✔️ API calls using NgRx Effects
✔️ Full CRUD operations
✔️ Optimistic & pessimistic updates
✔️ Loading & error state handling
✔️ DevTools debugging

Designed to demonstrate enterprise Angular patterns and best practices.
